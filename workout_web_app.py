...
def home_index():
    ...
    <li class="nav_bar"><a href="/premade_workouts">Workouts</a></li>
    <li class="nav_bar"><a href="/premade_meal_plans">Meal Plans</a></li>
    <li class="nav_bar"><a href="/tools">Tools</a></li>
    <li class="nav_bar"><a href="/about">About</a></li>
    </ul>
    </body>
    </html>
    """
...
def premade_workouts():
    ...
    <a href="/scheduling">Make a workout schedule</a><br>
